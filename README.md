[![Amor](https://github.com/Luandro-com/Amor/blob/master/screenshot.png)](http://compromissodeamor.com.br)
[![Build Status](https://travis-ci.org/roots/sage.svg)](https://travis-ci.org/roots/sage)
[![devDependency Status](https://david-dm.org/roots/sage/dev-status.svg)](https://david-dm.org/roots/sage#info=devDependencies)

Theme based on [Sage](https://roots.io/sage/) theme template. Sage is a WordPress starter theme based on HTML5 Boilerplate, gulp, Bower, and Bootstrap Sass, that will help you make better themes.
